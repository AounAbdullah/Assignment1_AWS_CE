...
ec2_client.run_instances(
    ...
    "ebs_optimized": true,
    "network_interfaces": [{"subnet_id": "subnet-0a51b0c02cc6cf0dc", "associate_public_ip_address": false, "device_index": 0, "groups": ["sg-0a57dad8dc33cf80f"]}],
    "credit_specification": {"cpu_credits": "unlimited"},
    "tag_specifications": [{"resource_type": "instance", "tags": [{"key": "Name", "value": "unievents-ec2-1"}]}],
